...
def get_distance_from_line(line_p1, line_p2, p3):
    """
        return distance between p3 and line (line_p1, line_p2)
    """
    return np.cross(line_p2 - line_p1, p3 - line_p1) / np.linalg.norm(line_p2 - line_p1)
