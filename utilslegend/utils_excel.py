...
class export_excel() :
    ...
    def update_line(self, sheet_name, time_update, list_counter_up, list_counter_dow) :
        current_row     = self.get_current_row(sheet_name)
        current_column  = 2
        # print(current_row)
        hour    = get_hour()
        # hour    = int(time_update / 60)
        minute  = int(time_update % 60)
        label_time = '{}:{}'.format(hour, minute)
        # print(label_time)
    ...
    def update_polygon(self, sheet_name, time_update, list_counter_up) :
        current_row     = self.get_current_row(sheet_name)
        current_column  = 2
        # print(current_row)
        hour    = int(time_update / 60)
...
def run() :
    ...
    time_update         = 45
    excel.update_line(sheet_name,time_update,  list_counter_up, list_counter_dow)
    time_update         = 60
    excel.update_line(sheet_name,time_update,  list_counter_up, list_counter_dow)
    time_update         = 65
    excel.update_line(sheet_name,time_update,  list_counter_up, list_counter_dow)
    ...
    time_update         = 830
    excel.update_line(sheet_name,time_update,  list_counter_up, list_counter_dow)
    excel.update_polygon(sheet_name2,time_update,  list_counter_up)
    excel.update_polygon(sheet_name2,time_update,  list_counter_up)
    excel.update_polygon(sheet_name2,time_update,  list_counter_up)
    excel.update_polygon(sheet_name2,time_update,  list_counter_up)
    # excel.update(10)
